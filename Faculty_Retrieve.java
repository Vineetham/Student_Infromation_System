...
public class Faculty_Retrieve extends AppCompatActivity implements FacultyFragmentDrawer.OnDrawerListener  {
   ...
   FacultyFragmentDrawer drawerFragment;
    ...
    private static final String URL_PRODUCTS="http://192.168.1.107/merit1/retrieve1.php";
    ...
    private TextView tx1,tx2,tx3,tx4,tx5,tx6,tx7,tx8,tx0,tx11;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tx11=(TextView)findViewById(R.id.txtbranch);
        ...
        tx11.setText(mFacultyProduct.getBranch());
