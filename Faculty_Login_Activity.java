...
import com.bagicode.www.bagilogindesign.FacultyLandingPageActivity;
import com.bagicode.www.bagilogindesign.Faculty_Register_Activity;
import com.bagicode.www.bagilogindesign.Faculty_product;
...
public class Faculty_Login_Activity extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        tx2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent;
                intent = new Intent(getActivity(), Faculty_Register_Activity.class);
    ...
    private class AsyncLogin extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                url = new URL("http://192.168.1.107/integrate1/lognew.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if(val.equals("Success")){
                    int id=jsonObject.getInt("fid");
                    String name=jsonObject.getString("fullname");
                    String fid=jsonObject.getString("facultyid");
                    ...
                    mFacultyProduct=new Faculty_product( id, name, fid,bran, dob, ema, gen,phno);
