...
public class Student_Retrieve extends AppCompatActivity  implements Fragment_Drawer.OnDrawerListener {
  ...
  //  Fragment_Drawer drawerFragment;
    ...
    private static final String URL_PRODUCTS="http://192.168.1.107/merit/retrieve.php";

    //a list to store all the products
    ArrayList<product> productList;
    private TextView tx1,tx2,tx3,tx4,tx5,tx6,tx7,tx8,tx0,tx11,tx12,tx13;
    ...
    protected void onCreate(Bundle savedInstanceState) {
     ...
     //   tx7=(TextView)findViewById(R.id.txt7);
       // tx8=(TextView)findViewById(R.id.txt8);
        ...
        tx11.setText(mStudentProduct.getBranch());
        tx12.setText(mStudentProduct.getSemester());
        tx13.setText(mStudentProduct.getSection());
                        ...
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                productList.add(new product(
                                        ...
                                        Faculty_Product.getString("branch"),
                                        Faculty_Product.getString("semester"),
                                        Faculty_Product.getString("section"),
