...
public class Student_Result_Retrieve extends AppCompatActivity implements Fragment_Drawer.OnDrawerListener {
    Fragment_Drawer drawerFragment;
    //this is the JSON Data URL
    //make sure you are using the correct ip else it will not work
    private static final String URL_PRODUCTS="http://192.168.1.107/merit/resultretrieve.php";

    //a list to store all the products
    List<Student_Result_Product> productList;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.student_result_retrieve);
                    ...
                    public void onResponse(String response) {
                        try {
                            ...
                            for (int i = 0; i < array.length(); i++) {
                                ...
                                productList.add(new Student_Result_Product(
                                        product.getInt("Sid"),
                                        product.getString("SubCode"),
                            ...
                            Student_Result_Product_Adapter adapter = new Student_Result_Product_Adapter(Student_Result_Retrieve.this, productList);
                            recyclerView.setAdapter(adapter);
                           // Toast.makeText(Student_Result_Retrieve.this, "", Toast.LENGTH_SHORT).show();
