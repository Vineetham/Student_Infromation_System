...
import com.bagicode.www.bagilogindesign.Attendance_Info;
import com.bagicode.www.bagilogindesign.Event_Product;
import com.bagicode.www.bagilogindesign.Landing_Page_Activity;
...
import com.bagicode.www.bagilogindesign.Student_Report_Adapter;
import com.bagicode.www.bagilogindesign.Student_Result_Product;
import com.bagicode.www.bagilogindesign.product;
...
public class Student_Login_Activity extends Fragment {
    ...
    public ArrayList<Event_Product> mStudentEventProductList;
    ...
    private class AsyncLogin extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                url = new URL("http://192.168.1.107/integrate/lognew1.php");
        ...
        protected void onPostExecute(String result) {
            ...
            try {
                ...
                if (val.equals("Success")) {
                    ...
                    String sec=jsonObject.getString("section");
                    ...
                    mStudentProduct = new product(rid, name,bran,sem,sec, usn, dob, ema, gen, phno);
                    ...
                    new  AsyncEvent().execute(bran,sem,sec);
                } else {
    ...
    private class AsyncAttend extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                url = new URL("http://192.168.10.116/merit/result.php");
            } catch (MalformedURLException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
                return "exception";
    ...
    private class AsyncEvent extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... params) {
            try {
                url = new URL("http://192.168.10.116/merit/student_event.php");
            } catch (MalformedURLException e) {
                // TODO Auto-generated catch block
                e.printStackTrace();
                return "exception";
            ...
            try {
                ...
                conn.setDoOutput(true);
                Uri.Builder builder = new Uri.Builder()
                        .appendQueryParameter("branch1", params[0])
                        .appendQueryParameter("semester1",params[1])
                        .appendQueryParameter("section1",params[2]);
                String query = builder.build().getEncodedQuery();
           ...
           // Toast.makeText(getActivity(), res, Toast.LENGTH_SHORT).show();
            ...
            try {
                ...
                for (int i = 0; i < jArr.length(); i++) {
                    ...
                    Event_Product studentEventProduct = new Event_Product(branch,semester,section,eventdate,eventdesc);
                    mStudentEventProductList.add(studentEventProduct);
                }
                Intent intent = new Intent(getActivity(), Landing_Page_Activity.class);
                //finishAffinity();
                startActivity(intent);
